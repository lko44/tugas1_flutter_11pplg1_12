...
//
//     final tableModelPremierLeague = tableModelPremierLeagueFromJson(jsonString);

import 'dart:convert';

TableModelPremierLeague tableModelPremierLeagueFromJson(String str) => TableModelPremierLeague.fromJson(json.decode(str));

String tableModelPremierLeagueToJson(TableModelPremierLeague data) => json.encode(data.toJson());

class TableModelPremierLeague {
    List<Table> table;

    TableModelPremierLeague({
        required this.table,
    });

    factory TableModelPremierLeague.fromJson(Map<String, dynamic> json) => TableModelPremierLeague(
